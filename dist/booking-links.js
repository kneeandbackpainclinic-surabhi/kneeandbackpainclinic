// Clinic Configuration & Booking Integrations
window.BOOKING_LINKS = {
  // Cal.id booking link for in-clinic appointments
  consultation: '',
  experienceSession: '',
  
  // Clinic appointment desk direct phone
  clinicPhone: '+912225880000', // Update with clinic desk line
  clinicEmail: 'info@charakhealthsolutions.com',
  ...
  // Webinar start ISO (can be updated for upcoming batches)
